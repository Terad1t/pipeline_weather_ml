...
url = f'https://api.openweathermap.org/data/2.5/weather?Sao Paulo,BR&units=metric&appid={API_KEY}'

@dag(
    dag_id='pipeline_weather_ml',
    default_args ={
        'owner': 'airflow',
    ...
    description= "Pipeline com machine-learning - Clima SP",
    schedule = '0 */1 * * * ',
